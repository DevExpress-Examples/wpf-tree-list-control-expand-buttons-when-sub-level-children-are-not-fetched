...
Namespace HasChildNodes
    ...
    Public Class ViewModel
        ...
        Private Sub InitBetaronProjectData(ByVal betaronProject As ProjectObject)
            ...
            Dim Task11 As Task = New Task() With {.Name = "Information Gathering", .Executor = "Kaiden Savastano", .Tasks = New ObservableCollection(Of Task)(), .HasChildNodes = True}
            ...
            Task12.Tasks.Add(New Task() With {.Name = "Documentation", .Executor = "Martez Gollin", .State = "Not started", .HasChildNodes = False})
            ...
            Task13.Tasks.Add(New Task() With {.Name = "Design of a web pages", .Executor = "Gasper Hartsell", .State = "Not started", .HasChildNodes = False})
            Task13.Tasks.Add(New Task() With {.Name = "Pages layout", .Executor = "Shirish Huminski", .State = "Not started", .HasChildNodes = False})
        ...
        Private Sub InitStantoneProjectData(ByVal stantoneProject As ProjectObject)
            ...
            Dim Task21 As Task = New Task() With {.Name = "Information Gathering", .Executor = "Huyen Trinklein", .Tasks = New ObservableCollection(Of Task)(), .HasChildNodes = True}
            ...
            Task22.Tasks.Add(New Task() With {.Name = "Documentation", .Executor = "Gorf Wobbe", .State = "Completed", .HasChildNodes = False})
            ...
            Task23.Tasks.Add(New Task() With {.Name = "Design of a web pages", .Executor = "Dominic Minden", .State = "In progress", .HasChildNodes = False})
            Task23.Tasks.Add(New Task() With {.Name = "Pages layout", .Executor = "Pinkerton Trezise", .State = "In progress", .HasChildNodes = False})
            ...
            Task24.Tasks.Add(New Task() With {.Name = "Design", .Executor = "Delilah Beamer", .State = "In progress", .HasChildNodes = False})
            Task24.Tasks.Add(New Task() With {.Name = "Coding", .Executor = "Dunaway Dupriest", .State = "Not started", .HasChildNodes = False})
